...
-- CreateIndex
CREATE UNIQUE INDEX "InstructorToken_instructorId_key" ON "InstructorToken"("instructorId");

-- CreateIndex
CREATE UNIQUE INDEX "Category_slug_key" ON "Category"("slug");

-- CreateIndex
CREATE INDEX "Course_isPublished_deletedAt_idx" ON "Course"("isPublished", "deletedAt");
...
-- AddForeignKey
ALTER TABLE "InstructorToken" ADD CONSTRAINT "InstructorToken_instructorId_fkey" FOREIGN KEY ("instructorId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
